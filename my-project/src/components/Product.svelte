	...
	let productFeatures = [
        {
            ...
            description:
                "Man Jesus ensures all users have the information they need to train safely and train effectively.",
...
<SecionWrapper id="product">
	<div class="flex flex-col gap-10 sm:gap-14 md:gap-24 flex-1 items-center justify-center pb-10 md:pb-14">
		<div class="flex flex-col gap-2">
			<p class="opacity-60 text-base sm:text-lg md:text-xl text-center">Start your lifetime 
				<span class="text-indigo-400">gmn streak </span>today 
			</p>
