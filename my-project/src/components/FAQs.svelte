        ...
        <div class="flex flex-col gap-8 sm:gap-10 md:gap-14 w-full">
            {#each faqs as faq}
                <div class="flex flex-col gap-2 text-left max-w-[800px] w-full mx-auto relative p-4 px-6" >
                    <div class="absolute top-0 left-0 bg-slate-950 w-1/3 h-[1px] -translate-x-4"></div>
                    <div class="absolute top-0 left-0 bg-slate-950 h-2/3 w-[1px] -translate-y-4"></div>
